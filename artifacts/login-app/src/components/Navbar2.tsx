...
export default function Navbar({ currentPage, setCurrentPage }: NavbarProps) {
  ...
  // Toggle drawer-open class on body for layout shift
  useEffect(() => {
    if (profileMenu) {
      document.body.classList.add("ympd-drawer-open");
    } else {
      document.body.classList.remove("ympd-drawer-open");
    }
    return () => { document.body.classList.remove("ympd-drawer-open"); };
  }, [profileMenu]);
