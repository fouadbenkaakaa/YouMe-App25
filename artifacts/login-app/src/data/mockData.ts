export const MOCK_POSTS = [
  {
    id: "1",
    author: { name: "سارة المنصور", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=sara&backgroundColor=ffdfbf", location: "جدة" },
    time: "منذ ٣ دقائق",
  ...
  {
    id: "2",
    author: { name: "محمد العمري", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=mohammed&backgroundColor=d1d4f9", location: "الرياض" },
    time: "منذ ٢٥ دقيقة",
  ...
  {
    id: "3",
    author: { name: "نورة الشمري", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=noura&backgroundColor=c0aede", location: "الدمام" },
    time: "منذ ساعة",
  ...
  {
    id: "4",
    author: { name: "عبدالله القحطاني", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=abdullah&backgroundColor=b6e3f4", location: "مكة المكرمة" },
    time: "منذ ٣ ساعات",
